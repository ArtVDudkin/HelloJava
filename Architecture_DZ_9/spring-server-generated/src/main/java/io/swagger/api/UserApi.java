...
public interface UserApi {
    ...
    ResponseEntity<User> createUser(@NotNull @Parameter(in = ParameterIn.QUERY, description = "The username for create account" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "username", required = true) String username, @NotNull @Parameter(in = ParameterIn.QUERY, description = "User email for news sending" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "email", required = true) String email, @NotNull @Parameter(in = ParameterIn.QUERY, description = "User phone for authorization" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "phone", required = true) String phone, @Parameter(in = ParameterIn.DEFAULT, description = "Created user account", schema=@Schema()) @Valid @RequestBody User body);


    @Operation(summary = "Delete user by ID", description = "This delete user account.", tags={ "user" })
    @ApiResponses(value = { 
    ...
    @Operation(summary = "Update user by ID", description = "This update info in user account.", tags={ "user" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "successful operation") })
    @RequestMapping(value = "/user/{userID}",
        consumes = { "application/json", "application/xml", "application/x-www-form-urlencoded" }, 
